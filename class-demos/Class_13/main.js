window.onload=()=>{
	...
	// we are setting the variable mytimer to an id that is created when the timer is sets
	let mytimer = setTimeout (hi, 2000)
	console.log(mytimer) // printing out ht eid of the timer
	clearTimeout(mytimer) //removing the timer 

	// add a tmer that repeats every 3 seconds
...
// function is just like let but to make a function insted of variable 
function sayHello(){
	console.log('Hello!')
